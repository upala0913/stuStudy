...
<body>
	...
	hello-----firstPage!
	<form id="addStuForm">
		<label>用户名：</label><input name="name" type="text" /> <br /> <input
			type="button" value="上传图片" id="upload"> <br />
		<ul id="imgList">
		</ul>
...
var editor1 = KindEditor.create(
	...
	<script type="text/javascript">
		function menu() {
			...
			KindEditor.each(
					'9px,10px,12px,14px,16px,18px,24px,32px'.split(','),
					function(i, val) {
						menu.addItem({
