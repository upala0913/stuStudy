...
public class CacheContextUtil implements ApplicationContextAware {
	...
	/**
	 *      * 根据提供的bean名称得到相应的服务类      * @param beanId bean的id      * @return
	 * 返回bean的实例对象      
	 */
	...
	/**
	 *      * 根据提供的bean名称得到对应于指定类型的服务类      * @param beanId bean的id      * @param
	 * clazz bean的类类型      * @return 返回的bean类型,若类型不匹配,将抛出异常      
	 */
